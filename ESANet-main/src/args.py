...
class ArgumentParserRGBDSegmentation(argparse.ArgumentParser):
    def set_common_args(self):
        ...
        self.add_argument(
            "--dataset",
            default="nyuv2",
            choices=["sunrgbd", "nyuv2", "cityscapes", "cityscapes-with-depth", "scenenetrgbd"],
        )
        self.add_argument(
            "--dataset_dir", default="/data/xyy/nyu5k/nyuv2", help="Path to dataset root."
        )  # nyuv2可以使用默认参数
        self.add_argument("--rec_data_dir", default=None, help="Path to dataset root.")
        # self.add_argument("--rec_data_dir", default="/data/chenminghui/ELIC/experiments/nyuv2_ELIC_united_LH_2_2.25/codestream/401-padding", help="Path to dataset root.")
        self.add_argument(
            "--ckpt_path",
            type=str,
            # required=True,
            default="/home/xyy/ESA_backup_0720/ESANet-main/trained_models/nyuv2/r34_NBt1D.pth",
            help="Path to the checkpoint of the trained model.",
        )
        self.add_argument("--draw", action="store_true", default=False, help="only 0928 for draw")

        ###############################以下内容不修改####################################
        # paths
        self.add_argument("--results_dir", default="./results")
        self.add_argument("--last_ckpt", default="", type=str, metavar="PATH", help="path to latest checkpoint")
        self.add_argument(
            "--pretrained_dir",
        ...
        # pretraining
        self.add_argument("--pretrained_scenenet", default="", help="the path to the weights pretrained on " "SceneNet")
        self.add_argument(
        ...
        # input dimensions
        self.add_argument("--batch_size", type=int, default=8, help="batch size for training")
        self.add_argument(
            "--batch_size_valid",
            type=int,
            default=None,
        ...
        self.add_argument(
            ...
            type=int,
            default=480,
            help="height of the training images. " "Images will be resized to this height.",
        )
        self.add_argument(
            "--width",
            type=int,
        ...
        # epochs
        self.add_argument("--epochs", default=500, type=int, metavar="N", help="number of total epochs to run")
        ...
        self.add_argument("--weight_decay", "--wd", default=1e-4, type=float, help="weight decay")
        self.add_argument("--momentum", default=0.9, type=float, metavar="M", help="momentum")
        self.add_argument("--optimizer", type=str, default="SGD", choices=["SGD", "Adam"])
        self.add_argument(
            "--class_weighting",
            type=str,
        ...
        self.add_argument(
            ...
            default=False,
            action="store_true",
            help="Set this if you want to initialize " "convolution layers with He initialization.",
        )
        self.add_argument(
            "--valid_full_res",
            default=False,
        ...
        self.add_argument(
            "--fuse_depth_in_rgb_encoder",
            default="SE-add",
            choices=["SE-add", "add", "None"],
            help="Fuses the depth feature maps in the rgb " "encoder maps over several layers in the " "encoder.",
        )
        self.add_argument(
            "--upsampling",
        ...
        self.add_argument(
            ...
            action="store_true",
            default=False,
            help="Whether to use the raw depth values instead of" "the refined depth values",
        )
        self.add_argument(
            "--aug_scale_min",
            default=1.0,
        ...
        # others
        self.add_argument("-j", "--workers", default=8, type=int, metavar="N", help="number of data loading workers")
        self.add_argument(
            "--debug", default=False, action="store_true", help="Only one batch in training and validation."
        )
